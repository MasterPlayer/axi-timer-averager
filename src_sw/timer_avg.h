...
#define timer_avg_set_msmt_limit(ptr, value) ((ptr)->average_ctrl_reg = ((ptr)->average_ctrl_reg & ~AVERAGE_CTRL_REG_AVG_MSMT_LIMIT_MASK) | ( (value << 8) & AVERAGE_CTRL_REG_AVG_MSMT_LIMIT_MASK))
